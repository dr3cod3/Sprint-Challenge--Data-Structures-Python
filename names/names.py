...
# Runtime ~.20, Runtime complexity O(log(n))
a = BSTNode("")
...
# structures, but you may not import any additional libraries
# that you did not write yourself.


# **** Using set() 0.0039sec, 0.0051sec, 0.0049sec ****
original = set(names_1)

duplicates = [name for name in names_2 if name in original]
